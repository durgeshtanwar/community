                ...
                <form role="form" @submit.prevent="(updatedata==true) ? updateMyDetails() : selfdata ? createMyUserDetail(): createUserDetails()" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-4">
                       <div class="form-group">
                        ...
                        <input type="text" v-model="form.spouse_name" class="form-control" placeholder="Spouse Name" name="spouse_name" :class="{'is-invalid':form.errors.has('spouse_name')}" >
                  ...
                  <div class="row">
                      <div class="col-sm-4">
                         ...
                         <select v-model="form.occupation" @change="getjobs()" class="form-control" name="occupation" :class="{'is-invalid':form.errors.has('occupation')}">
                          ...
                          <option value="business"> Self Business</option>
